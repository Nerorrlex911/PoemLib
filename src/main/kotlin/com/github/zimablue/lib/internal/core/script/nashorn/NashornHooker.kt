...
abstract class NashornHooker {
     ...
     * @return 返回值
     */
    abstract fun invoke(compiledScript: com.github.zimablue.lib.internal.core.script.nashorn.CompiledScript, function: String, map: MutableMap<String, Any>?, vararg args: Any): Any?
}